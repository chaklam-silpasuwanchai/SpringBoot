...
public class IntegrationConditionalRouteRoutingConfig2 {
		...
		public IntegrationFlow classify() {
			return IntegrationFlows.from(sourceDirectory(), 
					...
					.<File, String>route(new Function<File, String>(){
						@Override
						public String apply(File f) {
							...
							.channelMapping("txt", txtSource())
							.channelMapping("xml", xmlSource())
							.channelMapping("sql", sqlSource())
							)
					.get();
		}
